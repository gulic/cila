...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/bootsplash.eps}
...
encontraros que  pulsando la  tecla ñ  aparezca una \verb.p. o  algún otro
carácter. Los teclados españoles son del tipo qwerty-ES.

\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/mandrake_idioma.eps}
...
alrededor de 2 Gb de espacio en disco.}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/redhat_particiones.eps}
...
particiones deberemos usar particiones extendidas. Tendremos que eliminar
al  menos una  partición  primaria para  crear  una partición  extendida.
Desde este  momento podremos crear tantas  unidades lógicas como
deseemos a partir de esta partición extendida.}

\item[Unidades lógicas:]{  este tipo de particiones  son las que
se  crean  a partir  de  la  partición extendida, nunca  podremos  crear
unidades lógicas desde una partición primaria.}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/lycoris_ethernet.eps}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/lycoris_usuario.eps}
...
\begin{figure}[hbtp]
\centering\includegraphics[width=0.5\textwidth]{imagenes/xf86cfg.eps}
...
pulsamos el tercer botón.Respondemos con  y/n y apretamos {\tt Enter} para
...
para el idioma anteriormente elegido.  Pulsando a {\tt Enter} se pondrá la
opción por defecto,  y el programa nos preguntará  si queremos activar
las  opciones adicionales  del XKB  (en caso  de duda  {\tt n} seguido  de
{\tt Enter}) \\
...
{\tt Enter} para poder elegir nuestra tarjeta de video\\
...
modems an\-te\-rio\-res se pueden encontrar en la página www.linmodems.org.
...
\begin{figure}[hbtp]
\centering\includegraphics[width=0.7\textwidth]{imagenes/kpp.eps}
...
(como ejemplo usaremos 'nueva-conexion'). Elegimos nuestro tipo de DNS
...
\begin{figure}[hbtp]
\centering\includegraphics[width=0.7\textwidth]{imagenes/pppconfig.eps}
\caption{PPPConfig}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth]{imagenes/cups_instalando1.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/cups_instalando2.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/cups_instalando3.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/cups_instalando4.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/cups_configurando.eps}
\caption{CUPS 6}
\end{figure}
