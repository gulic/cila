...
tecla  ñ aparezca  una \verb.p.  o algún  otro carácter.  Los teclados
españoles son del tipo qwerty-ES.
...
el fdisk y el parted de Linux  y el diskdruid. Tened cuidado con estas
...
unidades lógicas empezarán a numerarse  a partir del cinco. Tenemos un
...
en modo lectura, ya que la  parte de escritura no está completada, por
...
los  componentes  del sistema  X  -  Window desarrolados  por  XFree86
...
su si se procede) y  tecleamos {\tt xf86config}. Nos encontraremos con
...
presionando la combinación  de teclas C-C. Así que no  debemos temer a
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/cups_inicio.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/cups_instalando1.eps}
