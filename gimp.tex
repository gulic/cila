...
de diálogo  para preguntarte por  el nombre del  fichero en el  que la
quieres  guardar y  algunos  detalles  más. Lo  mismo  sucederá si  en
cualquier imagen eliges {\sf Archivo $\rightarrow$ Guardar como...} en
...
XXX ESCRIBIR EN LA FACULTAD XXX
...
\caption{Selección realizadas con tijeras inteligentes}
\end{figura}

\subsubsection{Seleccionar regiones por colores (7)}
\index{\gimp!herramientas!seleccionar regiones por colores}

Sirve para seleccionar  {\bf todas} las región de  píxeles con colores
...
\subsubsection{Rellenar con un graciente de colores (16)}

\subsubsection{Dibujar trazos afilados de lápiz (17)}

\subsubsection{Dibujar trazos borrosos de brocha (18)}

\subsubsection{Borrar al color de fondo o transparente (19)}
