...
consola o terminal. Para salir  del intérprete puedes pulsar {\tt C-c}
o bien ejecutar  la función \verb+Exit();+. Pulstar  {\tt C-c} también
es útil  para detener  inmediatamente la  ejecución del  intérprete de
Yacas (o de un script escrito para Yacas).
