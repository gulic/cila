...
Este  tema está  dedicado a  \LaTeX\  y pretende  versar sobre  lo
básico que se debe poder emplear  en la mayoría de las aplicaciones de
\LaTeX.  Existen  diversos manuales~\cite{llmanual,companion}  donde  se
...
El propósito  de este  tema \emph{no} es  indicar cómo  se instala
...
\item[El primer apartado] muestra la estructura básica de los
  ...
  \LaTeX. Tras leer este tema deberías tener una visión muy
  ...
  otras fuentes ---como los manuales~\cite{llmanual,companion}---.
\item[El segundo apartado] incide en los detalles sobre la
...
\begin{intro}
  ...
  de \LaTeX. Tras leer este tema, podrás tener un conocimiento
...
\index{Lamport, Leslie}Leslie Lamport~\cite{llmanual}. Utiliza el
...
\begin{intro}
  Tras leer este tema deberiás conocer los elementos básicos de
  los que se compone un documento de \LaTeXe. En este tema
...
tema, hemos creado entornos especiales para estructuras que se
...
\begin{intro}
  ...
  propósito de este tema es añadir algunas `especias'\ a tus
