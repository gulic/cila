...
formato sólo permite escala de grises.
...
\item PSD:  formato usado por  el Adobe Photoshop (The  GIMP mantendrá
las capas existentes).

\item PSP: formato usado por el  PaintShop Pro (The GIMP mantendrá las
capas existentes).
...
diréctamente  al GIMP.  El  formato  del nombre  del  fichero es  {\tt
