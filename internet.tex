...
aquí se realizan las tareas deseadas  mediante los comandos de FTP que
...
\begin{verbatim}
$ scp <usuario>@<máquina_origen>:<archivo_origen> <usuario>@<máquina_destino>:<archivo_destino>
\end{verbatim}
