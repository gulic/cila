...
Fetchmail  es una  aplicación  que nos  permite  descargar de  nuestro
...
Para   la  configuración   del   fetchmail  se   utiliza  el   fichero
...
usuarios es  la utilización de  el fetchmail como demonio.  Creamos el
fichero  de  configuración y  lo  movemos  a /etc/fetchmailrc.  En  la
