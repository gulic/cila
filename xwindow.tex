...
\begin{figure}[hbtp]
\centering
\includegraphics[width=\textwidth]{imagenes/xwindow.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/gdm.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/btitulo.eps}
...
que podemos emplear antes de  iniciar el proceso de autentificación, y
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/gnome_menu.eps}
\caption{Menú de panel de GNOME}\label{gnome_menu}
\end{figure}

\begin{figure}[hbtp]
\centering
\includegraphics[width=0.5\textwidth]{imagenes/gnome_menu_principal.eps}
\caption{Panel alineado de GNOME y menú principal}
...
\ref{gnome_menu_principal}).  Si  pulsamos  en  la  huella  del  panel
inferior, o seleccionamos  alguna de las opciones  del panel superior,
dispondremos de acceso a las aplicaciones instaladas en el sistema. La
mayor  parte de  las  aplicaciones {\sf  GNOME}  están clasificadas  y
disponibles en alguno  de los submenús correspondientes.  (p. ej. {\tt
APLICACIONES}, {\tt  UTILIDADES}, {\tt GRÁFICOS}, etc).  En {\tt MENÚS
KDE}  se  encuentran clasificadas  todas  las  aplicaciones {\sf  KDE}
instaladas,  y en  {\tt MENÚS  DEBIAN}  todas las  aplicaciones de  la
distribución, independientemente  del entorno  de escritorio  para las
que fueron  desarrolladas. En  este punto  es importante  recordar que
podemos  ejecutar  cualquiera de  las  aplicaciones  sin importar  que
estemos trabajando en un entorno  de escritorio diferente a aquel para
el que fueron diseñadas.

\begin{figure}[hbtp]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/gnome_favoritos.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/gnome_menu_persis.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.6\textwidth]{imagenes/gnome_menu_contexto.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/gnome_apliques.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/gnome_gmc.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/gnome_nautilus.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/gnome_control.eps}
\caption{Centro de control GNOME}
\label{gnome_control}
\end{figure}

La  configuración  para  personalizar  nuestros  escritorio  se  puede
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.8\textwidth]{imagenes/pantallazo_kde_descrito.eps}
\caption{Aspecto del escritorio KDE}
\label{kde}
\end{figure}

{\sf  KDE} es  entorno de  escritorio  con gestor  de ventanas  propio
basado  en {\sf  X-Window}  que  nos da  un  entorno gráfico  amigable
para  realizar  las  operaciones  más comunes  con  nuestro  ordenador
...
nuestro trabajo mucho más cómodo, o  pasar buenos ratos de ocio frente
al ordenador.
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/kde_panel.eps}
...
los gestores  de ventanas  y entornos  gráficos que  podamos encontrar
...
aspecto, tamaño y funcionalidades.

\begin{figure}[hbtp]
\centering
\includegraphics[width=0.35\textwidth]{imagenes/kde_menuk.eps}
\caption{Menú ``K'' desplegado}
\label{kde_menuk}
\end{figure}
...
programas  se distribuyen  en  varios submenús,  y  se clasifican  por
tipos.  Normalmente, estos  submenús  suelen tener  títulos como  {\tt
PROGRAMAS}, {\tt MULTIMEDIA}, etc\dots

El emulador  de terminal  puede conseguirse en  {\sf KDE}  mediante el
botón que aparece en el panel que simboliza un monitor con una pequeña
concha (shell en inglés) en  su esquina superior izquierda. No debemos
...
mediante el  cual podemos  configurar la  totalidad de  los parámetros
gráficos, estéticos, de sonido, de rendimiento, de manejo, etc.

\begin{figure}[hbtp]
\centering
\includegraphics[width=0.5\textwidth]{imagenes/pantallazo_kde_ejecutar.eps}
\caption{Cuadro de diálogo {\tt EJECUTAR} tras pulsar en {\tt OPCIONES }}
\label{kde_ejecutar}
\end{figure}

Una de  las combinaciones de teclas  más útiles en {\sf KDE}  es {\tt A-F2},
que  nos muestra  el  cuadro de  diálogo {\tt  EJECUTAR},  en el  cual
...
A  esta última  opción  se  accede pulsando  el  botón {\tt  OPCIONES}
...
directos o enlaces, carpetas,etc),  ejecutar comandos, activar menú de
escritorio (lo  cual nos muestra  las opciones del menú  que obtenemos
con el  botón derecho, en  la parte  superior de nuestra  pantalla, de
forma permanente.
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.8\textwidth]{imagenes/kde_konqueror_web.eps}
\caption{Konqueror como navegador web}
\label{kde_konqueror_web}
\end{figure}

Para  movernos  por  nuestros  archivos, así  como  para  navegar  por
Internet, {\sf KDE} pone a nuestra disposición una potente aplicación:
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.8\textwidth]{imagenes/kde_konqueror_dir.eps}
...
embargo, si  ponemos un recurso  FTP, {\sf Konqueror}  muestra también
una vista de carpetas, mediante  la cual podemos manejar cómodamente y
de forma  transparente dichos  recursos. Por  ejemplo podemos  subir y
bajar archivos con tan sólo arrastrar y soltar.

Para arrancar {\sf Konqueror}, debemos pulsar en el icono con un globo
terráqueo  y  un  engranaje  situado  en  nuestro  panel  (ver  Figura
\ref{kde_panel}).
