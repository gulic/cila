...
\begin{figure}[hbtp]
\centering
\includegraphics[width=\textwidth]{imagenes/pantallazo_kde_descrito.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.5\textwidth]{imagenes/kde_menuk.eps}
\caption{Menú ``K'' desplegado}\label{Menu ``K''}
\end{figure}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=\textwidth]{imagenes/kde_konqueror_web.eps}
\caption{Konqueror como navegador web}\label{Konqueror como navegador web}
\end{figure}

\begin{figure}[hbtp]
\centering
\includegraphics[width=\textwidth]{imagenes/kde_konqueror_dir.eps}
