...
KDE es un gestor de ventanas basado en el entorno X-Window que nos da un
entorno gráfico amigable para realizar las operaciones más comunes con 
nuestro ordenador. Cuenta con un panel donde tener nuestras aplicaciones
organizadas, un gestor de archivos y navegador web (Konqueror), y otros
muchos programas para hacer nuestro trabajo (o nuestros ratos de ocio con
el ordenador) mucho más cómodos.

Los programas se encuentran situados en el menú con una ''K`` y un engranaje
(primer icono de la izquierda del panel), distribuidos en varios submenús, y
clasificados por tipos. Normalmente, estos submenús tendrán títulos como
''Programas``, ''Multimedia``, etc...

\includegraphics{imagenes/pantallazo_descrito_kde.eps}
