...
\item[RPM:] \index{administracion!RPM, paquetes} es el  tipo de paquetes más popular. Creada  por Red Hat y
que utilizan la mayoría de las las distribuciones.

\item[DEB:] \index{administraicon!DEB, paquetes} creada por  el grupo  Debian.

\item[TARBALLS:] \index{administracion!TARBALLS, paquetes} éstos  son  ficheros comprimidos  que  contienen  el
...
esto no funciona, no se puese asegurar  que el sistema funcione con estabilidad
