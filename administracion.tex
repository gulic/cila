...
\item El fichero wtmp. En el hay un listado de todas las conecciones que ha tenido la máquinamientras ha permanecido encendida. Se puede visulizar con el comando wtmp.
\end{itemsize}
