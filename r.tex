...
fuente de datos la tabla contenida  en el fichero {\tt muestra.tex} No
...
% Histogramas, con curvas y lines()

% Tartas, con colores

% Gráficos de cajas y cuartil-cuartil

% Regresiones lineales

% Superficies en 3D, como la del volcán
