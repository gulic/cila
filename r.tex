...
\item[{\tt cov(x,y)}] Calcula la covarianza de  {\tt x} y {\tt y}, que
pueden ser dos vectores o dos matrices.

\item[{\tt cor(x,y)}] Calcula  la correlación entre de {\tt  x} y {\tt
y}, que pueden ser dos vectores o dos matrices.

\item[{\tt sd(x)}] Calcula la desviación  estándar de los valores {\tt
x}, que puede ser un vector o una matriz. Su cuadrado
...
La función más frecuentemente usada para crear gráficas nuevas es {\tt
...
un vector  numérico con un  diagrama de cajas  (boxplot), y un  par de
factores como un diagrama de barras  con cada barras dividida según el
factor.
