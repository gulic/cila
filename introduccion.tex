...
Helsinki, Finlandia, allá por 1991. Linus basó el Linux en una pequeña
implementación  de UNIX  para  PC con  fines  didácticos llamada  {\em
Minix}. A  finales de  ese año  se hizo público  Linux con  la versión
...
desarrollo hoy  en día  gracias a  un equipo  mundial dirigido  por él
mismo, que trabaja a través de Internet.

Gran  parte del  {\em software}  desarrollado  para Linux  lo creó  el
...
programador, Richard M.  Stallman que, al igual que  sus compañeros de
profesión, fue testigo de la  primera gran transformación del mundo de
la programación en industria cerrada.
...
le bautizó con el críptico nombre de GNU, y para defenderlo se creó la
Licencia  Pública General  (GPL, sus  siglas en  inglés), un  peculiar
...
por  cierto, su  nombre es  Tux)  se convirtió  en poco  tiempo en  el
...
por sí  solo no  forma todavía un  sistema operativo.  Justamente para
UNIX existe una multitud de {\em software} libre, lo que significa que
éstos están disponibles también para  Linux y son estas utilidades las
que  realmente forman  el  sistema operativo.  Entonces  es cuando  ya
hablamos de {\bf GNU/Linux}.
...
Como anécdota interesante, comentar que {\tt http://www.es.debian.org}
se  encuentra  en la  misma  Universidad  en  la  que estudian  o  han
estudiado los autores de este curso.
...
\item  {\bf  Red Hat}:  La  primera  distribución Linux  en  dirigirse
seriamente hacia los usuarios finales. \\ {\tt http://www.redhat.com}
...
memoria posible del  sistema (GigaBytes) y no permite  que se produzca
...
lo tiene  Linux. Llega un momento  en que no  se echa de menos  a {\em
Windows}.
...
entornos de {\em  Windows}. Si a eso añadimos que  los virus para {\em
Windows} no se pueden ejecutar  en Linux salvo contadísimos casos, nos
...
diferencia con {\em  Windows} es que mientras éste sólo  dispone de un
escritorio,  en  Linux  podemos  elegir con  qué  escritorio  queremos
trabajar. Los  más conocidos  son KDE, GNOME,  AfterStep, Enlightment,
donde  los dos  primeros son  los más  populares. Lo  más curioso  del
asunto es que con ellos se ha iniciado una ``guerra dialéctica'' sobre
cuál es mejor. Al  final, la ventaja reside en la  variedad con la que
el usuario puede decidir con cuál se siente más cómodo.
...
tiempo, dada  la demanda  creciente de  usuarios decididos  a utilizar
Linux algunos  fabricantes ha  comenzado a acceder  a las  demandas de
estos últimos.
...
dos últimos son  aplicaciones que aspiran a ser  serias alternativas a
AutoCAD aplicadas a los entornos UNIX), etc.
...
tres caminos: \begin{itemize} \item El primero es el de dar las mismas
funcionalidades que  las que tienen  esas aplicaciones que  existen en
{\em Windows}, aunque su aspecto externo  no tenga nada que ver con el
Windows.

\item El segundo camino añade además el aspecto externo original de la
aplicación que funciona en {\em Windows}  con el fin de que el usuario
se encuentre en un entorno familiar.
...
nombrar  una de  las aplicaciones  más utilizadas  en el  entorno {\em
Windows} que es {\em MS Word}.  Del primer ejemplo nos encontramos con
{\bf KWord},  desarrollado por el equipo  que creó KDE.

El  segundo es  {\bf  AbiWord}. El  autor reconoce  que  es casi  como
utilizar  el {\em  MS  Word}, aunque  es evidente  que  aún le  faltan
bastantes opciones por desarrollar.

Y el tercero es el {\bf \LaTeX}, una herramienta muy potente, pero que
...
leyendo se  ha escrito usando  precisamente {\bf \LaTeX}. Al  final la
