...
a cargo de una compañía llamada StarDivision,  cuyos derechos fueron comprados en  
1999 por Sun Microsystems.
La version 5.2 of StarOffice se lanzó en junio del 2000, y la versión 6.0 salió
en mayo del 2002. Lo más extraordinario del desarrollo de StarOffice 6.0 es que se
desarrolla mayoritariamente en el contexto del proyecto Open Source de OpenOffice.org. 
A efectos de posibilitar dicho desarrollo, Sun hizo público el código fuente de la mayoría 
de los módulos de StarOffice (excepto por algunos módulos de proveedores externos, que no 
han entrado en el proyecto), y estableció el proyecto OpenOffice.org. Esto no significa sin 
embargo que Sun deja en manos de voluntarios el desarrollo futuro del suite: la mayoría del
trabajo todavía se lleva a cabo por desarrolladores de Sun. Sun también se encarga de los 
...
Openoffice.org es una suite ofimática que está compuesta por diferentes módulos
que se pueden cargar de forma independiente.
Este capítulo no está orientado a ser un manual exhaustivo de
OpenOffice.org, sino más bien una introducción a este enorme paquete,
...
\begin{figura}{writer_empezar}{1}
Primer vistazo al OpenOffice.org Writer
\end{figura}
...
asistentes para documentos, para cerrar OpenOffice.org Writer hay pulsar en este menú la
opción cerrar.
...
Una vez que se ha abierto OpenOffice.org, para abrir una sesión de OpenOffice.org Writer hay
...
StarCalc, la hoja de cálculo perteneciente al paquete ofimático OpenOffice.org.
...
\comando{Nueva Hoja de Cálculo} dentro del escritorio del entorno OpenOffice.org.
...
resto de la suite OpenOffice.org. Seleccionaremos el menú \menu{Archivo} e
...
directamente con listas. En la versión 5.2 de OpenOffice.org se instala por defecto el soporte
...
\begin{figura}{StarCalcBasic}{1}
Entorno de StarBasic
\end{figura}
...
\begin{figura}{StarImpress}{1}
Presentaciones en OpenOffice.org
\end{figura}
...
\begin{figura}{StarDraw}{1}
El creador de ilustraciones de OpenOffice.org
\end{figura}
...
de aplicación} de OpenOffice.org y cuáles a la \textbf{ventana de
documento} de Draw.
...
utilizará la traducción al español utilizada en OpenOffice.org, que no
...
El modo de crear curvas de Bézier en OpenOffice.org Draw presenta algunas
...
llaman <<cuerpos de revolución>>. En OpenOffice.org Draw se pueden crear
...
OpenOffice.org se llama FontWork. Se selecciona el texto, en el menú
...
ver, esto es algo que OpenOffice.org Draw sólo admite con algunos
...
\begin{figura}{StarSchedule}{1}
Organizar las tareas con StarSchedule
\end{figura}
...
\begin{figura}{StarChart}{1}
Armado de gráficas en OpenOffice.org
\end{figura}
...
Cuando se comienza una nueva imagen en OpenOffice.org y se arranca el módulo Image, lo primero
...
\begin{figura}{StarImageNuevaImagen}{1}
...
En la ilustración de la derecha se muestra una ventana de OpenOffice.org que contiene un
...
\textbf{ventana de aplicación} de OpenOffice.org y cuáles a la \textbf{ventana de documento} de Image.

\begin{figura}{StarImageNuevaImagenSin}{1}
Ventana nueva imagen
\end{figura}
...
\begin{figura}{StarImageColores}{1}
Selector de Colores
\end{figura}

\begin{figura}{StarImageEscalaGrises}{1}
Conversión a grises
\end{figura}
...
\begin{figura}{StarImageModificarTam}{1}
Modificar tamaño
\end{figura}
...
\begin{figura}{StarImageEscala}{1}
Barra de escala
\end{figura}
...
\begin{figura}{StarImagePlumas}{1}
Plumas
\end{figura}
...
\begin{figura}{StarImageImagen}{1}
Reflejos
\end{figura}
...
\begin{figura}{StarImageBrillo_y_Contraste}{1}
Brillo y contraste
\end{figura}
...
\begin{figura}{StarImageFiltroMenu}{1}
Menú de filtros
\end{figura}

\begin{figura}{StarImageFiltros}{1}
Barra de filtros
\end{figura}
