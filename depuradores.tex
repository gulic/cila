...
\index{Depuradores!GNU Debugger (GDB)}
...
circunstancia pasajera, vamos  a colocar un {\em  punto de ruptura} o punto
de ruptura.
...
punto de ruptura en el  {\tt ddd} es simplemente desplazarse hasta  la línea donde
deseamos colocar  el punto de ruptura y  hacer un  doble click con  el boton
izquierdo del ratón.
...
punto de ruptura  con el  boton derecho  vemos que  se nos  da la  opcion de
...
que nuestro punto de ruptura sea inteligente  y no pare la ejecución siempre
que  el programa  pase por  allí, sino  que solo  se parará  cuando la
expresión  se cumpla,  por ejemplo,  si ponemos  el punto de ruptura  en un
...
hemos de poner en  propiedades del punto de ruptura es {\tt i  = 5000} y de
...
Ahora que  ya tienes un  watch y un  punto de ruptura, en este  momento solo
podemos ir  saltanto de  punto de ruptura en  punto de ruptura, y  esto no  nos es
...
que  hacemos es  colocar  un  punto de ruptura al  inicio  de  la funcion  o
...
punto de ruptura temporal.}

\item[{\em Cont}:]{(continuar)  saltamos  hasta  el siguiente  punto de ruptura  o
hasta el final del programa si es  que no hay ningún punto de ruptura más en
