...
mpg321 es  un programa de reproducción  de ficheros con formato  mp3 u
ogg-vorbis.  Es un  programa  de  línea de  comandos  y  de manejo  no
interactivo,  esto  es, uno  ejecuta  el  programa  con una  serie  de
argumentos, y  una vez  el programa comienza  a ejecutarse,  no existe
interacción  entre el  usuario y  el programa,  sino que  se limita  a
realizar las  operaciones que  le hemos proporcionado  en la  línea de
comandos.


La forma  más asequible para  reproducir mp3(o bien ficheros  ogg) con
mpg321 es  el siguiente comando,suponiendo  que nos encontremos  en un
directorio lleno de mp3 :-)
