...
Una utilidad que nos podría resultar interesante sería ejecutar comandos del sistema desde la misma consola en la que estamos trabajando con el {\sf VIM}. En modo {\em comando} escribimos {\tt :!comando}, por ejemplo, si escribimos {\tt :!ls} nos mostrará un listado de archivos del directorio en el que nos encontramos.Para buscar palabras dentro de un documento es fácil, solo tenemos que escribir en modo {\em comando} {\tt /palabra} y si salen varios resultados, solo tendremos que apretar {/tt n} y nos los irá mostrando. Si lo que queremos es desplazarnos por un documento muy grande (como por ejemplo el código fuente de un programa) a líneas concretas el {\sf VIM} lo soluciona. Para  desplazarnos a la línea 60 de un documento, lo que haríamos sería escribir en modo {\em comando} {\tt 60} y luego apretar las teclas {\tt Mayúsculas-g}. Es decir, deberíamos teclear el número de línea al que queremos acceder y luego apretar las teclas Mayúsculas-g. Otro comando que nos ayuda en nuestra tarea de desarolladores es el comando \%. Si estamos trabajando con algunas sintaxis de algunos programas que manejen con mucha regularidad (, [ o $\lbrace$ , el {\sf vim} nos permite con apretar la tecla \% situarnos sobre uno de estos caracteres que nos muestre el de cierre o apertura que le corresponda. Si estamos escribiendo un  texto sobre cualquier tema y en todo el texto el nombre Pedro debe ser sustituido por Juan, {\sf VIM} nos ayuda. Escribiremos en modo comando {\tt :s }/ {\tt Pedro} / {\tt Juan} / {\tt g}, si queremos que solo se sustituya en la línea en la que nos encontramos, suprima la {\tt g}. Quedaría así el esquema para utilizarlo, {\tt :s} / {\sf palabra a cambiar} / {\sf palabra nueva}. Añadiríamos a este esquema / {tt g} sí queremos que se sustituya en todo el documento.
...
\hline
 {\tt \% } & Nos muestra el paréntesis o llave posterior o anterior de la que nos encontremos situados \\
\hline
 {\tt !comando} & Nos permite ejecutar un comando del sistema sin salir del editor \\
\hline
 {\tt :s/palabra1/palabra2/g} & Sustituye en todo el documento la palabra1 por la palabra2 \\
\hline
\end{tabular}
