...
Borramos la última línea como haríamos en el {\tt edit} del {\tt DOS},
...
que el kwrite de KDE sólo que en este caso es para el entorno de GNOME
...
simultáneamente varios  ficheros fuente  con un  solo editor  y varias
