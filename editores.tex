...
La tecla  {\tt F10}  nos da acceso  a todos los  menús de  Emacs, menu
archivo, edición,  cambio entre las  distintas ventanas de  edición de
texto, etc.
...
editor de texto, etc\dots y la tecla  {\tt C} nos daría acceso, si las
tenemos  instaladas, a  las  posibilidades que  ofrece  emacs para  la
...
realizar  cualquiera de  las operaciones  que nos  ofrece. Algunas  de
las  combinaciones de  teclas para  movernos cómodamente  por nuestros
documentos son:
...
secuencia de teclas "Ctrl U" "24" "Alt + f"
...
movernos por  el texto,  debemos pasar al  llamado ``modo  comando'' y
...
ficheros  de configuración  que puedas  encontrar en  UNIX/Linux. Otra
...
\begin{verbatim}
"hola.c" [New] 6L, 60C written                            6,1           All
\end{verbatim}

En esta  línea {\sf VI} nos  indica que ha escrito  el fichero hola.c,
que es nuevo, que tiene un tamaño de 60 caracteres en 6 líneas. Además
...
ejecutar el comando {\tt :syntax on}. Si te devuelve el mensaje de que
esa  función no  está  implementada  es que  no  tienes disponible  el
coloreado de sintaxis. Si por el contrario funciona pero no te gusta y
quieres quitarlo ejecuta el comando  {\tt :syntax off} y desaparecerán
los colores.  En la  interfaz gráfica  de {\sf VIM}  hay un  menú {\sf
Esquemas  de colores}  dentro del  menú {\sf  Editar}. También  puedes
cambiar el  esquema de colores desde  la interfaz de consola  del {\sf
VIM}  con el  comando {\tt  :colors esquema}.  Por ejemplo,  activa el
