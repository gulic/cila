...
argumento el nombre del programa, podremos hacerle una traza. El
siguiente sería un ejemplo de ejecución de un programa pascal desde
gdb.

\begin{verbatim}
$ gdb programa

(mensajes de inicio de gdb omitidos)
(gdb) list
1        program programa;
2        var variable:string;
3
4 	 begin
5               for a:=1 to 10 do
6		begin
