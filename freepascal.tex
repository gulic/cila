...
{\tt Anjuta} Tal vez, el mejor editor para programadores (o al menos, en
opinión del autor de esta sección). Soporta resaltado de sintaxis para varios
idiomas, compilar y ejecutar desde el mismo editor, etc.
...
{\tt Vim} El autor de esta sección sólo ha usado de vim la funcionalidad
de resaltado de sintaxis mientras programaba en Pascal. Esta se activa
con la opción ":syntax on".

{\tt Scite} Es un editor muy minimalista, y algo lioso de configurar, pero es
un editor para programadores muy bueno, cómodo, y sobre todo, compacto(cabe en
un disco de 1'44), además de estar disponible tanto para plataformas Win32 
como GNU/Linux.
