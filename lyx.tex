...
utilizar también en \LyX. Sin embargo no necesitas ningún conocimiento
de \LaTeX~  para manejar \LyX, aunque  lo que sí necesitas  es aprender
los conceptos y la mentalidad de la forma de trabajo de \LyX~ y \LaTeX:
sólo debes preocuparte de escribir el contenido, \LyX~ se encargará del
trabajo de formato y composición de forma consistente.
